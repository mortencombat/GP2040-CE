...
std::string setAddonOptions()
{
    ...
    docToPin(turboOptions.shmupEnable1Pin, doc, "pinShmupEnable1");
    docToPin(turboOptions.shmupEnable2Pin, doc, "pinShmupEnable2");
    docToPin(turboOptions.shmupEnable3Pin, doc, "pinShmupEnable3");
    docToPin(turboOptions.shmupEnable4Pin, doc, "pinShmupEnable4");
...
std::string getAddonOptions()
{
    ...
    writeDoc(doc, "pinShmupEnable1", cleanPin(turboOptions.shmupEnable1Pin));
    writeDoc(doc, "pinShmupEnable2", cleanPin(turboOptions.shmupEnable2Pin));
    writeDoc(doc, "pinShmupEnable3", cleanPin(turboOptions.shmupEnable3Pin));
    writeDoc(doc, "pinShmupEnable4", cleanPin(turboOptions.shmupEnable4Pin));
